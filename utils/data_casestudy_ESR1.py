...
def load_data(args, rp, train_test='train'):
    ...
    """
    # 构造前缀：注意 '_' 是目录
    prefix0 = os.path.join(args.data_dir, 'processed_case_study_ESR1', f'repeat{rp}', '0', train_test)
    prefix1 = os.path.join(args.data_dir, 'processed_case_study_ESR1', f'repeat{rp}', '1', train_test)
